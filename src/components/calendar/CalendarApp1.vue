  ...
  setup() {
    ...
    const calendarOptions: CalendarOptions = {
      ...
      views: {
        dayGridMonth: {
          buttonText: t(
            "componentsList.calendarApp.calendarOptions.dayGridMonth.buttonText"
          ),
        },
        timeGridWeek: {
          buttonText: t(
            "componentsList.calendarApp.calendarOptions.timeGridWeek.buttonText"
          ),
        },
        timeGridDay: {
          buttonText: t(
            "componentsList.calendarApp.calendarOptions.timeGridDay.buttonText"
          ),
        },
      },
