...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      {
        path: "/apps/custom-table/lists",
        name: "apps-custom-table-lists",
        component: () => import("@/views/apps/CustomTable/lists.vue"),
        meta: {
      ...
      {
        path: "/apps/custom-table/lists/:id",
        name: "apps-custom-table-lists-edit",
        component: () => import("@/views/apps/CustomTable/edit.vue"),
        meta: {
          pageTitle: "Custom Table Edit",
          breadcrumbs: ["Apps", "CustomTable"],
        },
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "two-step",
        component: () =>
          import("@/views/crafted/authentication/basic-flow/TwoStep.vue"),
        meta: {
          pageTitle: "Two Step",
        },
      },
...
router.beforeEach((to, from, next) => {
  ...
  //TODO: uncomment this line to enable auth verification
